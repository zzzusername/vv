...
class All {
  ...
  static GetMediaServerManagement(MediaServe) {
    ...
    var isContainOrgChinldren=MediaServe.isContainOrgChinldren;


    return axios.get(URL + '/api/Provider/MediaServer?UniqueCode=' + UniqueCode + '&Name=' + Name + '&PageIndex=' + PageIndex + '&PageSize=' + PageSize + '&ClientKey=' + localStorage.clientKey + '&Token=' + localStorage.token+'&isContainOrgChinldren='+isContainOrgChinldren+'&UserId='+localStorage.userId, {
