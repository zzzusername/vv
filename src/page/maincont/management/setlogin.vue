			...
			<div class="zTable">
				<div class="elTable">
					<div class="scrollbox">
						...
						:data="setloginData"
						>
							<el-table-column prop="message" label="注册信息"></el-table-column>
							<el-table-column prop="" label="状态" >
								<template slot-scope="scope">
									<el-radio v-model="scope.row.state" label="1">必填</el-radio>
                                    <el-radio v-model="scope.row.state" label="2">可选</el-radio>
                                    <el-radio v-model="scope.row.state" label="3">不显示</el-radio>
								</template>
							</el-table-column>
						</el-table>
					</div>
