  ...
  <div class="content" id="cont">
    <div class="app-cent">
      <div class="hd">
        <span>新增工作单位</span>
        <span class="btnRight">
          <button class="Zbtn btn-rt" @click="addDatalist">新增工作单位</button>
        </span>
      </div>
      <div class="bd">
        <div class="tree">
...
import { getRegionsbyPid, getRegiondetail } from "../../api/commonapi";
export default {
  data() {
    return {
      tabIndex: "1",
  ...
  methods: {
    ...
    renderContent(h, { node, data, store }) {
      return (
        ...
        >
          <span>
            <span style={{ color: data.type == "2" ? "#f7e59a" : "#fff" }}>
              {node.label}
            </span>
          </span>
          <span>
