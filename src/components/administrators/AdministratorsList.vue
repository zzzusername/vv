<template>
	<div class="mRight" id="Upgradeview">
        ...
        <!--<span>工号</span><input v-model="zInput" class="zInput" type="text" placeholder="" />-->
	...
	export default {
		...
		methods: {
			...
			getVersionList(isall) {
				...
				this.$http.post(URL + '/super/admin/api/v1/user/list_personal_infos',par ).then(function(res) {
