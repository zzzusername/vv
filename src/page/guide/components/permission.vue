  ...
  <div class="content" id="cont">
    <div class="app-cent">
      <div class="hd">
        <span>权限分组</span>
        <span class="btnRight">
          <button class="Zbtn btn-rt" @click="addPermissiondata(true)">新增权限分组</button>
        </span>
      </div>
      <div class="bd table">
      ...
      <div class="adminContpop">
        ...
        <div class="adminTable">
          ...
          >
            ...
            <el-table-column prop="is_admin" label="职务"></el-table-column>
            <el-table-column prop label="操作">
              <template slot-scope="scope">
        ...
        <el-form ref="perForm" :model="perForm" label-width="140px">
          ...
          <div id="tabChagecont">
            ...
            <el-tabs v-model="activeName" type="border-card" style="padding:0 10px;">
              <el-tab-pane label="模块分配：" name="first" class="tabSelectpane">
...
import $ from 'jquery'
// js
import {arrayObjdeweighting} from '../../untils/heightAuto' //注意路径
/* api */
...
/* 权限样式重置 */
#tabChagecont .tabCont .hd{
	margin: 0;
	padding: 0;
}
#tabChagecont .tabCont .bd{
	padding: 0;
	border: none;
}
#tabChagecont .tabCont .bd .hd-l{
	padding: 0;
	height: 205px;
    overflow-y: auto;
}
